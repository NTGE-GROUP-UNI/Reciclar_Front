    ...
    return (
        <div
            className="
                ...
                items-center w-full bg-zinc-100 dark:bg-zinc-900 font-inter
                px-8
            "
        >
            <section
            ...
            >
                ...
                >
                    <h1
                        className="
                            text-3xl md:text-5xl font-extrabold text-[--primary-blue-color] dark:text-blue-400 leading-normal mb-4
                        "
                    >
                        {title}
                    </h1>
                    <p
                        className="
                            text-lg md:text-xl text-[--primary-blue-color] dark:text-blue-400 leading-normal
                        "
                    >
                        {text}
                    </p>
